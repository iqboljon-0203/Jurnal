...
const App = () => {
  ...
  return (
    <div className="h-[28.38rem] bg-[#1a365d]">
        ...
        <nav className=" py-4 bg-[#FFFFFF1A] px-12 ">
          ...
          <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  className="bg-transparent text-white input_inner placeholder-white w-72 h-10 pt-2  pr-2  pb-2  pl-4  rounded-3xl border-2 border-white focus:outline-none focus:ring-1 focus:ring-white/70"
                />
                <button type='submit'>
