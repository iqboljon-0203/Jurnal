    ...
    <div className="w-full">
      <div className="max-w-[81.25rem] mx-auto xl:px-4 px-8 py-12">
        ...
        <div className="mb-16">
          ...
          {language === 'uz' ? info.uz : language === 'ru' ? info.ru : info.en}  
          </p>
        </div>
