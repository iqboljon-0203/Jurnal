    ...
    <div className="w-full">
      <div className="max-w-[81.25rem] mx-auto xl:px-4 px-8 py-12">
        ...
        <div className="mb-16">
          ...
          {language === 'uz' ? <p>{info.uz} <br /> <br /> {info.uz1} <br /> <br /> {info.uz2}</p>  : language === 'ru' ? <p>{info.ru} <br /> <br /> {info.ru1} <br /> <br /> {info.ru2}</p> : <p>{info.en} <br /> <br /> {info.en1} <br /> <br></br> {info.en2}</p>}  
          </p>
        </div>
