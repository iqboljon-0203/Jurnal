      ...
      <header className="h-full  flex flex-col container mx-auto px-4 ">
        ...
        <main className="flex-grow flex flex-col items-center justify-center -mt-20">
          <div className='main_article_path text-base font-normal leading-[1.37rem] text-center text-white mb-6'>
                Bosh sahifa / <span className='text-base font-normal leading-[1.37rem] text-left'>Biz haqimizda</span> / <span className='text-base font-normal leading-[1.37rem] text-left text-[#FFFFFF80]'>Tahririyat hay’ati</span>
          </div>
          ...
          "Fan va Texnologiyalar universiteti" Ilmiy jurnali Tahririyat hay’ati va Jamoatchilik kengashi a’zolari
          </p>
        </main>
      </header>
    </div>
