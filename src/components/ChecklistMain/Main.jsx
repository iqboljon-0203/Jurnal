      ...
      <header className="h-full  flex flex-col container mx-auto px-4 ">
        ...
        <main className="flex-grow flex flex-col items-center justify-center -mt-20">
          <div className='main_article_path text-base font-normal leading-[1.37rem] text-center text-white mb-6'>
                Bosh sahifa / <span className='text-base font-normal leading-[1.37rem] text-left'>Mualliflar uchun</span> / <span className='text-base font-normal leading-[1.37rem] text-left text-[#FFFFFF80]'>Tekshirish roʻyxati</span>
          </div>
          ...
          <p className='w-1/2 text-lg font-normal leading-[1.57rem] text-left text-white mb-6'>
            Iltimos: <br />
            1. Umumiy ma'lumotga ega bo'lish va maqolangiz ushbu jurnalga mos kelishini baholash uchun "Yo‘nalishlar" bo‘limini o'qing; <br />
            2. Qo'lyozmangizni tayyorlash uchun Microsoft Word shablonidan foydalaning; <br />
            3. Nashr etikasi, mualliflik huquqi, rasm formatlari, ma'lumotlar va havolalar formati masalalari tegishli tarzda ko'rib chiqilganligiga ishonch hosil qiling; <br />
            4. Barcha mualliflar taqdim etilgan maqola mazmunini ma’qullaganligiga ishonch hosil qiling va ular Mualliflar uchun yo‘riqnomani o‘qiganliklarini tasdiqlang.
          </p>
